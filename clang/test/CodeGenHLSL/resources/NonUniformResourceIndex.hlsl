...
void main(uint GI : SV_GroupID) {
  ...
  // CHECK: call void @hlsl::RWBuffer<float>::RWBuffer(unsigned int, int, unsigned int, unsigned int, char const*)
  // CHECK-SAME: (ptr {{.*}}, i32 noundef 0, i32 noundef 10, i32 noundef %[[NURI_1]], i32 noundef 0, ptr noundef @A.str)
  ...
  // CHECK: call void @hlsl::RWBuffer<float>::RWBuffer(unsigned int, int, unsigned int, unsigned int, char const*)
  // CHECK-SAME: (ptr {{.*}}, i32 noundef 0, i32 noundef 10, i32 noundef %[[MOD]], i32 noundef 0, ptr noundef @A.str)
  ...
  // CHECK: call void @hlsl::RWBuffer<float>::RWBuffer(unsigned int, int, unsigned int, unsigned int, char const*)
  // CHECK-SAME: (ptr {{.*}}, i32 noundef 0, i32 noundef 10, i32 noundef %[[ADD2]], i32 noundef 0, ptr noundef @A.str)
