...
// CHECK: VarDecl {{.*}} a1.Buf 'hlsl::RWBuffer<float>' callinit
// CHECK: HLSLResourceBindingAttr {{.*}} Implicit "u0" "space0"
...
// CHECK: HLSLResourceBindingAttr {{.*}} Implicit "u2" "space0"

// CHECK: VarDecl {{.*}} b1 'hlsl_constant B'
// CHECK-NEXT: HLSLResourceBindingAttr {{.*}} "u2" "space0"
...
// CHECK: HLSLResourceBindingAttr {{.*}} Implicit "u3" "space0"

// CHECK: VarDecl {{.*}} implicit c1.Buf2 'hlsl::RWBuffer<float>' callinit
// CHECK: HLSLResourceBindingAttr {{.*}} Implicit "u4" "space0"
...
// CHECK: HLSLResourceBindingAttr {{.*}} Implicit "t0" "space0"

// CHECK: VarDecl {{.*}} implicit f.a.Buf 'hlsl::RWBuffer<float>' callinit
// CHECK: HLSLResourceBindingAttr {{.*}} Implicit "u20" "space0"

// CHECK: VarDecl {{.*}} implicit f.SrvBuf 'hlsl::StructuredBuffer<float>' callinit
// CHECK: HLSLResourceBindingAttr {{.*}} Implicit "t1" "space0"

// CHECK: VarDecl {{.*}} implicit f.Samp 'hlsl::SamplerState' callinit
// CHECK: HLSLResourceBindingAttr {{.*}} Implicit "s3" "space0"
...
// CHECK: HLSLResourceBindingAttr {{.*}} "u1" "space1"
