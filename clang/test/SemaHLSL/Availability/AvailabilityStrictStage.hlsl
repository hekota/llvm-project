...
float also_dead(float f) {
  ...
  // expected-error@#also_dead_fy_call {{'fy' is only available in compute shader environment on Shader Model 6.5 or newer}}
  // expected-note@#fy {{'fy' has been marked as being introduced in Shader Model 6.5 in compute shader environment here, but the deployment target is Shader Model 6.0 compute shader environment}}
...
float dead(float f) {
  ...
  // expected-error@#dead_fy_call {{'fy' is only available in compute shader environment on Shader Model 6.5 or newer}}
  // expected-note@#fy {{'fy' has been marked as being introduced in Shader Model 6.5 in compute shader environment here, but the deployment target is Shader Model 6.0 compute shader environment}}
